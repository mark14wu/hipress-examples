...
for gpu_id in gpus:
    ...
    code_hipress_mxnet_command = "scp ./hipress_mxnet/hipress_mxnet.py 192.168.1.%d:~/sparse_adam/hipress_mxnet.py" % (40 + gpu_id)
    code_hipress_pytorch_command = "scp ./hipress_pytorch/hipress_pytorch.py 192.168.1.%d:~/sparse_adam/hipress_pytorch.py" % (40 + gpu_id)
    code_torchddp_command = "scp ./torchddp/torchddp_vgg.py 192.168.1.%d:~/sparse_adam/torchddp_vgg.py" % (40 + gpu_id)
