...
class UGATIT(object) :
    def __init__(self, args):
        ...
        self.partition_threshold = args.partition_threshold
    ...
    def train(self):
        ...
        for step in range(start_iter, self.iteration + 1):
            ...
            if bps.rank() == 0:
                this_time = time.time()
                speed = bps.size() * self.batch_size / (this_time - last_time)
